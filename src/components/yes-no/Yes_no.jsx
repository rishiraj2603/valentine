...
const Yes_no = () => {
  ...
  return (
    <div className="overflow-hidden flex flex-col items-center justify-center pt-[2rem] mt-[12rem] h-dvh selection:bg-rose-600 selection:text-white text-zinc-900">
      {yesPressed ? (
        <>
          <img
            src={bg_yes}
